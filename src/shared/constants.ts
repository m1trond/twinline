...
export const messageColumns = "id, author, text, created_at, edited_at, user_id, recipient_id";
export const messageReceiptColumns = "id, message_id, sender_id, recipient_id, status, created_at";
export const messageTypingStateColumns = "sender_id, recipient_id, action, event_at, expires_at";
export const messagePinColumns = "message_id, pinner_id, recipient_id, is_pinned, created_at, updated_at";
export const usernamePattern = /^[a-z0-9_]{3,24}$/;
const activeViews: ActiveView[] = ["profile", "messages", "favorites", "music", "access", "settings"];
