...
export function ImagePreviewOverlay({ imageUrl, onClose }: ImagePreviewOverlayProps) {
  ...
  return (
    <button
      ...
      type="button"
    >
      <span className="absolute right-4 top-4 rounded-full border border-[#3f3f46]/45 bg-[#111111]/90 px-4 py-2 text-sm font-medium text-[#f4f4f5] transition hover:border-[#f4f4f5]/25 hover:bg-white/10 active:scale-[0.98]">
        {t("close")}
      </span>
